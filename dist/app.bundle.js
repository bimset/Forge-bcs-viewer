...
if (window._viewerMain) {

  // I added this to handle some specific cases
  if(this.window._viewerMain.impl.selector) {

    this.window._viewerMain.tearDown()
    this.window._viewerMain.finish()
    this.window._viewerMain = null
  }
}
